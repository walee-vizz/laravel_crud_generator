                ...
                <div class="col">
                    <div class="form-group">
                        ...
                        <input type="text" name="mail_mailer" id="mail_mailer" class="form-control"
                            value="{{ old('mail_mailer') ? old('mail_mailer') : $settings->mail_mailer }}">
                    </div>
                </div>
                <div class="col">
                    <div class="form-group">
                        ...
                        <input type="text" name="mail_host" id="mail_host" class="form-control"
                            value="{{ old('mail_host') ? old('mail_host') : $settings->mail_host }}">
                    </div>
                </div>
                <div class="col">
                    <div class="form-group">
                        ...
                        <input type="text" name="mail_port" id="mail_port" class="form-control"
                            value="{{ old('mail_port') ? old('mail_port') : $settings->mail_port }}">
                    </div>
                ...
                <div class="col">
                    <div class="form-group">
                        ...
                        <input type="text" name="mail_username" id="mail_username" class="form-control"
                            value="{{ old('mail_username') ? old('mail_username') : $settings->mail_username }}">
                    </div>
                </div>
            </div>
                ...
                <div class="col">
                    <div class="form-group">
                        ...
                        <input type="password" name="mail_password" id="mail_password" class="form-control"
                            value="{{ old('mail_password') ? old('mail_password') : $settings->mail_password }}">
                    </div>
                </div>
                <div class="col">
                    <div class="form-group">
                        ...
                        <input type="text" name="mail_encryption" id="mail_encryption" class="form-control"
                            value="{{ old('mail_encryption') ? old('mail_encryption') : $settings->mail_encryption }}">
                    </div>
                </div>
                <div class="col">
                    <div class="form-group">
                        ...
                        <input type="email" name="default_email" id="default_email" class="form-control"
                            value="{{ old('default_email') ? old('default_email') : $settings->default_email }}">
                    </div>
                ...
                <div class="col">
                    <div class="form-group">
                        ...
                        <input type="text" name="default_email_title" id="default_email_title" class="form-control"
                            value="{{ old('default_email_title') ? old('default_email_title') : $settings->default_email_title }}">
                    </div>
                </div>
            </div>
                ...
                <div class="col">
                    <div class="form-group">
                        ...
                        <input type="text" name="google_client_id" id="google_client_id" class="form-control"
                            value="{{ old('google_client_id') ? old('google_client_id') : $settings->google_client_id }}">
                    </div>
                </div>
                <div class="col">
                    <div class="form-group">
                        ...
                        <input type="text" name="google_client_secret" id="google_client_secret" class="form-control"
                            value="{{ old('google_client_secret') ? old('google_client_secret') : $settings->google_client_secret }}">
                    </div>
                </div>
                <div class="col">
                    <div class="form-group">
                        ...
                        <input type="text" name="google_client_redirect_uri" id="google_client_redirect_uri"
                            class="form-control"
                            value="{{ old('google_client_redirect_uri') ? old('google_client_redirect_uri') : $settings->google_client_redirect_uri }}">
                    </div>
                </div>
            </div>
            <hr>
                ...
                <div class="col">
                    <div class="form-group">
                        ...
                        <input type="text" name="aws_secret_access_key" id="aws_secret_access_key"
                            class="form-control"
                            value="{{ old('aws_secret_access_key') ? old('aws_secret_access_key') : $settings->aws_secret_access_key }}">
                    </div>
                </div>
                <div class="col">
                    <div class="form-group">
                        ...
                        <input type="text" name="aws_default_region" id="aws_default_region" class="form-control"
                            value="{{ old('aws_default_region') ? old('aws_default_region') : $settings->aws_default_region }}">
                    </div>
                </div>
                <div class="col">
                    <div class="form-group">
                        ...
                        <input type="text" name="aws_bucket" id="aws_bucket" class="form-control"
                            value="{{ old('aws_bucket') ? old('aws_bucket') : $settings->aws_bucket }}">
                    </div>
                </div>
                ...
                <div class="col">
                    <div class="form-group">
                        ...
                        <input type="text" name="aws_access_key_id" id="aws_access_key_id" class="form-control"
                            value="{{ old('aws_access_key_id') ? old('aws_access_key_id') : $settings->aws_access_key_id }}">
                    </div>
                </div>
                <div class="col">
                    <div class="form-group"
                        style="margin-top: 6%;display: flex;justify-content: flex-start; align-items: center;">
                        <input type="checkbox" name="aws_use_path_style_endpoint" id="aws_use_path_style_endpoint"
                            value="1"
                            @if (old('aws_use_path_style_endpoint')) checked
                                            @elseif($settings->aws_use_path_style_endpoint)
                                            checked
                                            @else @endif
                ...
                <div class="col">
                    <div class="form-group">
                        ...
                        <input type="text" name="paypal_client_id" id="paypal_client_id" class="form-control"
                            value="{{ old('paypal_client_id') ? old('paypal_client_id') : $settings->paypal_client_id }}">
                    </div>
                </div>
                <div class="col">
                    <div class="form-group">
                ...
                <div class="col">
                    <div class="form-group">
                        ...
                        <input type="text" name="paypal_currency" id="paypal_currency" class="form-control"
                            value="{{ old('paypal_currency') ? old('paypal_currency') : $settings->paypal_currency }}">
                    </div>
                </div>
            </div>
            {{-- End --}}
