                    ...
                    <form action="{{ route('admin.generate_crud.submit') }}" method="post">
                        ...
                        <div class="form-group">
                            <div class="row">
                                ...
                                <div class="col">
                                    <label for="view_path">View Files Path</label>
                                    <input type="text" class="form-control @error('view_path') is-invalid @enderror" name="view_path" id="view_path"
                                        placeholder="Default path is resources/views/">
                                </div>
                            </div>
                            <div class="row">
                                <div class="col">
                                    <label for="create_views">Create Views</label>
                                    <select name="create_views " id="create_views" class="form-control  @error('create_views') is-invalid @enderror">
                            ...
                            <div class="field_wrapper border-1 border-light shadow-sm p-3 mb-3">
                                <div class="form-group">
                                    <div class="row">
                                        ...
                                        <input type="text" name="fields[0][name]" class="form-control field_name"
                                            required>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col">
                                                    <div class="form-group" style="">
                                                        <label class="text-center">Validation: <sup>(optional)</sup>
                                                        </label>
                                                        <input type="text" name="fields[0][types][validation]"
                                                            class="form-control subfield_validation "
                                                            placeholder="required | max:3 etc... ">
                                                ...
                                                <div class="col">
                                                    <div class="form-group" style="text-align: -webkit-center;">
                                                        <div class="row">
                                                            <div class="col">
                                                                <label class="text-center" for="view_checkbox"> View
                                                                    Page:</label>
                            ...
                            <div class="subfield_wrapper">
                                <div class="subfield">
                                            <div class="row">
                                                ...
                                                <div class="col">
                                                    <div class="form-group" style="">
                                                        <label class="text-center">Validation:<sup>(optional)</sup>  </label>
